...
## 2. Habilitar o encaminhamento de pacotes

Necessário para a máquina rotear o tráfego de outros dispositivos (IPv4 e IPv6).
...
### Anunciando várias redes

> **Atenção:** este comando **substitui** as rotas anunciadas acima — ele não soma.
> Liste todas as sub-redes desejadas de uma vez.
